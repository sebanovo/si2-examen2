...
@Component({
	...
	templateUrl: "./technician-edit-dialog.html",
	styleUrl: "./technician-edit-dialog.css",
	changeDetection: ChangeDetectionStrategy.OnPush,
})
export class TechnicianEditDialog {
	...
	readonly updateTechnician = output<UpdateTechnicianFormValue>();
